export const schemaStatements = [
  `CREATE TABLE IF NOT EXISTS control_settings (
    ...
    followup_days TEXT NOT NULL DEFAULT '6,10,15,30,45',
    target_markets TEXT NOT NULL DEFAULT 'Tier 1 logistics, fleet, freight, transportation, field-service, and operational software; Tier 2 operational B2B SaaS with a verified trigger',
    ideal_customer_profile TEXT NOT NULL DEFAULT 'Founder-led software companies with a live product or working MVP, normally 3-50 employees, 0-6 engineers, funded or revenue-backed, and a current need for audit, MVP delivery, stabilization, technical ownership, or fundraising readiness',
    lead_titles TEXT NOT NULL DEFAULT 'Named Founder, Co-Founder, CEO, CTO, Head of Product, or Product Lead with a verified personal email',
